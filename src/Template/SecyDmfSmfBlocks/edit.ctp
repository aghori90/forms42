...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $secyDmfSmfBlock->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $secyDmfSmfBlock->id)]
            )
        ?></li>
...
<div class="secyDmfSmfBlocks form large-9 medium-8 columns content">
    <?= $this->Form->create($secyDmfSmfBlock) ?>
    <fieldset>
        <legend><?= __('Edit Secy Dmf Smf Block') ?></legend>
        <?php
            ...
            echo $this->Form->control('verified', ['empty' => true]);
