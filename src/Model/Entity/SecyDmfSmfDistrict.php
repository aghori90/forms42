 ...
 * @property float $previous_month_quantity
 * @property float $previous_month_payable_amount
 * @property float|null $previous_month_paid_amount
 * @property float $current_month_quantity
 * @property float $current_month_payable_amount
 ...
 */
class SecyDmfSmfDistrict extends Entity
{
    /**
