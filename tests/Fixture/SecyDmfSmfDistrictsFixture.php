...
/**
 * SecyDmfSmfDistrictsFixture
 */
class SecyDmfSmfDistrictsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'previous_month_quantity' => ['type' => 'decimal', 'length' => 12, 'precision' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'previous_month_payable_amount' => ['type' => 'decimal', 'length' => 12, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'previous_month_paid_amount' => ['type' => 'decimal', 'length' => 12, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'current_month_quantity' => ['type' => 'decimal', 'length' => 12, 'precision' => 3, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'current_month_payable_amount' => ['type' => 'decimal', 'length' => 12, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        'current_month_paid_amount' => ['type' => 'decimal', 'length' => 12, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'total_expenses' => ['type' => 'decimal', 'length' => 12, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_indexes' => [
            'yearMonthForm' => ['type' => 'index', 'columns' => ['month_id', 'year_id', 'form_code_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'distitem' => ['type' => 'unique', 'columns' => ['rgi_district_code', 'form_code_id', 'item_id', 'yojna', 'month_id', 'year_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'freeze' => 1,
                'created' => '2021-03-10 07:40:39',
                'created_by' => 1,
                'modified' => '2021-03-10 07:40:39',
                'modified_by' => 1
            ],
        ];
        parent::init();
